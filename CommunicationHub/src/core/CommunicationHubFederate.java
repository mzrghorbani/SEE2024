...
public class CommunicationHubFederate extends SEEAbstractFederate implements Observer {

	private static final int MAX_WAIT_TIME = 10000;
	
	
	private CommunicationHub communicationHub = null;
	...
	public CommunicationHubFederate(SEEAbstractFederateAmbassador seefedamb, CommunicationHub communicationHub) {
		super(seefedamb);
	...
	public void configureAndStart(Configuration config) throws ConnectionFailed, InvalidLocalSettingsDesignator, UnsupportedCallbackModel, 
		...
		if(!SynchronizationPoint.INITIALIZATION_STARTED.isAnnounced()){
			 ...
			 */
			super.publishElement(communicationHub, "CommunicationHub");
	...
	protected void doAction() {
		...
		Position curr_pos = this.communicationHub.getPosition();
		curr_pos.setX(curr_pos.getX()); // update the x coordinate

		try {

			super.updateElement(this.communicationHub);
			System.out.println("Communication Hub recieving updates");
	...
	public void update(Observable arg0, Object arg1) {
		...
		System.out.println("The CommunicationHub has received an update");
		if(arg1 instanceof ExecutionConfiguration){
		    ...
		    System.out.println("Communication Hub updated");
