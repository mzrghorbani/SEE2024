...
class TestFederate implements FederateAmbassador {
    ...
    private class MyFederateAmbassador implements FederateAmbassador {
        ...
        // Implement methods of the FederateAmbassador interface
        // You can provide empty implementations for methods you don't need
    }
	...
	TestFederate(String[] var1) {
		...
		federateAmbassador = new MyFederateAmbassador();
	}
	...
	private void run() throws Exception {
		...
		federateAmbassador.announceSynchronizationPoint(FEDERATION_NAME, null);
