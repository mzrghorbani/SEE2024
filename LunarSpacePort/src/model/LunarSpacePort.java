...
@ObjectClass(name = "PhysicalEntity.LunarSpacePort")
public class LunarSpacePort {
	...
	public LunarSpacePort(){}

	public LunarSpacePort(String name, String type, String parent_name, Position position, Quaternion quaternion) {
		this.name = name;
		this.type = type;
	...
	public void info(ReferenceFrame referenceFrame) {
		...
		System.out.println("Current Frame: " + referenceFrame.getFrame());
        ...
        System.out.println("LunarSpacePort currentPosition: " + currentPosition);
    }
