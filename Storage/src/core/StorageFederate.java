...
public class StorageFederate extends SEEAbstractFederate implements Observer {
	...
	public StorageFederate(SEEAbstractFederateAmbassador seefedamb, Storage Storage) {
		super(seefedamb);
	...
	public void configureAndStart(Configuration config) throws ConnectionFailed, InvalidLocalSettingsDesignator, UnsupportedCallbackModel, 
		...
		if(!SynchronizationPoint.INITIALIZATION_STARTED.isAnnounced()){
			 ...
			 */
			super.publishElement(storage, "Storage");
	...
	protected void doAction() {
		...
		Position curr_pos = this.storage.getPosition();
		curr_pos.setX(curr_pos.getX()); // update the x coordinate

		try {

			super.updateElement(this.storage);
	...
	public void update(Observable arg0, Object arg1) {
		...
		System.out.println("The Storage has received an update");
