...
public class SpaceportFederate extends SEEAbstractFederate implements Observer {
	...
	protected void doAction() {
		...
		Position curr_pos = this.spaceport.getPosition();
		curr_pos.setX(curr_pos.getX()); // update the x coordinate
		curr_pos.setY(curr_pos.getY()); // update the x coordinate
		curr_pos.setZ(curr_pos.getZ()); // update the x coordinate

		try {

			super.updateElement(this.spaceport);
			System.out.println("Spaceport " + curr_pos);
	...
	public void update(Observable arg0, Object arg1) {
		...
		System.out.println("Spaceport position published");
...
//			System.out.println("Type is not instance of Execution Configuration");
			ReferenceFrame referenceFrame = (ReferenceFrame) arg1;
			System.out.println("Frame: " + referenceFrame.getFrame());
			System.out.println("State: " + referenceFrame.getState());
			System.out.println("ReferenceFrame state updated");
		}
	}
	
//	@Override
//	public void update(Observable arg0, Object arg1) {
//	    System.out.println("The Spaceport has received an update");
//	    
//	    if (arg1 instanceof ExecutionConfiguration) {
//	        ExecutionConfiguration executionConfig = (ExecutionConfiguration) arg1;
//
//	        System.out.println("ExecutionConfiguration received:");
//	        System.out.println("Current execution mode: " + executionConfig.getCurrent_execution_mode());
//	        System.out.println("Next execution mode: " + executionConfig.getNext_execution_mode());
//
//	        // Handle execution mode transitions here if needed
//
//	    } else if (arg1 instanceof ReferenceFrame) {
//	        ReferenceFrame referenceFrame = (ReferenceFrame) arg1;
//
//	        System.out.println("ReferenceFrame received:");
//	        System.out.println("Frame: " + referenceFrame.getFrame());
//	        System.out.println("State: " + referenceFrame.getState());
//	        System.out.println("Time: " + referenceFrame.getT_parent_body());
//	        
//	        // Handle reference frame updates here if needed
//
//	    } else {
//	        System.out.println("Unknown type received: " + arg1.getClass());
//	    }
//
//	    try {
//	        Thread.sleep(500);
//	    } catch (InterruptedException e) {
//	        System.err.println("Error occurred while sleeping: " + e.getMessage());
//	    }
//	}
}
