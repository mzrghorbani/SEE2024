...
public class HabitationFederate extends SEEAbstractFederate implements Observer {
	...
	public HabitationFederate(SEEAbstractFederateAmbassador seefedamb, Habitation habitation) {
		super(seefedamb);
	...
	public void configureAndStart(Configuration config) throws ConnectionFailed, InvalidLocalSettingsDesignator, UnsupportedCallbackModel, 
		...
		if(!SynchronizationPoint.INITIALIZATION_STARTED.isAnnounced()){
			 ...
			 */
			super.publishElement(habitation, "Habitation");
	...
	protected void doAction() {
		...
		Position curr_pos = this.habitation.getPosition();
		curr_pos.setX(curr_pos.getX()); // update the x coordinate

		try {

			super.updateElement(this.habitation);
	...
	public void update(Observable arg0, Object arg1) {
		...
		System.out.println("The Habitation has received an update");
